import "../css/Introduce.Introduce.scss";
        ...
        <div className="introduce_box">
          <div className="intro_head">
            ...
            <div className="Intrduce_head">
              <div className="intro_title">환영합니다! 호서그림전</div>
              <div>
                여기는 예술의 아름다움을 담은 온라인 그림전의 문으로 여러분을
                초대합니다.<br></br> 호서그림전은 예술가들의 창의력과 다양성이 만나
                공존하는 특별한 공간입니다.
              </div>
            </div>
          </div>
          <div className="page-content">
            <div className="card">
              <div className="card_content">
                ...
                <div className="content_text">
                  ...
                  더 아름답게 만들고자 합니다. 호서그림전은 예술의 다양한 양상을
            ...
            <div className="card">
              <div className="card_content">
                ...
                <div className="content_text">
                  호서그림전은 회화, 조각, 사진, 디지털 아트 등 다양한 예술
            ...
            <div className="card">
              <div className="card_content">
                ...
                <div className="content_text">
                  호서그림전은 온라인 플랫폼을 통해 누구나 손쉽게 그림의
            ...
            <div className="card">
              <div className="card_content">
                ...
                <div className="content_text">
                  호서그림전은 예술을 사랑하는 모든 이들에게 열린 문입니다.
